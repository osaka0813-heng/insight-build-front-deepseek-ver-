...
const styles = StyleSheet.create({
  ...
  nodeWrap: { alignItems: 'stretch', flexDirection: 'column', gap: 8 },
  node: { backgroundColor: colors.white, borderColor: colors.gray300, borderRadius: 12, borderWidth: StyleSheet.hairlineWidth, paddingHorizontal: 12, paddingVertical: 11, width: '100%' },
  ...
  nodeArrow: { alignSelf: 'center', color: colors.gray400, fontSize: 15, fontWeight: '700', transform: [{ rotate: '90deg' }] },
