...
export function ReadingPager({ edition, onOpenArchive, onOpenProcess, dailyState, continuity, onOpenDailyLanding, onOpenEditorial, activeScope, onChangeScope }: Props) {
