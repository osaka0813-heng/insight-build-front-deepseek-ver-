...
export const REMOTE_CONTENT_URL =
  'https://raw.githubusercontent.com/osaka0813-heng/insight-build-front-deepseek-ver-/main/published-content.json';

export const REMOTE_CONTENT_FETCH_TIMEOUT_MS = 8_000;
export const REMOTE_CONTENT_MIN_REFRESH_INTERVAL_MS = 0;
export const REMOTE_CONTENT_CACHE_KEY = '@insight/published-content/v1';
